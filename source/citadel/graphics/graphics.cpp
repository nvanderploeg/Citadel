...
namespace {
    ...
    // sample triangle hardcode for VBO testing
...
#pragma mark - Debug and validation
    ...
    void VulkanGraphics::PickPhysicalDevice()
    {
        ...
        for (const auto& device : devices) {
            ...
            if (isDeviceSuitable(device)) {
                ...
                std::cout <<"Picked: " << props.deviceName << std::endl;
                break;
            }
        }
    ...
    void VulkanGraphics::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) 
    {
    ...
    void VulkanGraphics::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
        VkCommandBuffer commandBuffer = BeginSingleTimeCommands();
    ...
    VkImageView VulkanGraphics::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) 
    {
